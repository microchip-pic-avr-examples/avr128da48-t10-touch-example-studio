...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(21), Y(23), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16       \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(16), Y(23), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16       \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(6), Y(23), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16        \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(17), Y(23), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16       \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(21), Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16        \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(16), Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16        \
	}
#define NODE_6_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(6), Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_7_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(17), Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16        \
	}
...
#define SCROLLER_0_PARAMS                                                                                              \
	{                                                                                                                  \
		SCROLLER_TYPE_SLIDER, 4, 4, SCROLLER_RESOL_DEADBAND(SCR_RESOL_8_BIT, SCR_DB_5_PERCENT), 8, 20                  \
	}
